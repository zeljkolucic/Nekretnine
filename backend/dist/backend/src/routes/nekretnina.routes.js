...
nekretninaRouter.route('/azurirajNekretninu').post((req, res) => new nekretnina_controller_1.NekretninaController().azurirajNekretninu(req, res));
...
nekretninaRouter.route('/dohvatiBrojNekretninaUGradu').post((req, res) => new nekretnina_controller_1.NekretninaController().dohvatiBrojNekretninaUGradu(req, res));
nekretninaRouter.route('/dohvatiBrojKucaKojeSeIzdaju').get((req, res) => new nekretnina_controller_1.NekretninaController().dohvatiBrojKucaKojeSeIzdaju(req, res));
nekretninaRouter.route('/dohvatiBrojKucaKojeSeProdaju').get((req, res) => new nekretnina_controller_1.NekretninaController().dohvatiBrojKucaKojeSeProdaju(req, res));
nekretninaRouter.route('/dohvatiBrojStanovaKojiSeIzdaju').get((req, res) => new nekretnina_controller_1.NekretninaController().dohvatiBrojStanovaKojiSeIzdaju(req, res));
nekretninaRouter.route('/dohvatiBrojStanovaKojiSeProdaju').get((req, res) => new nekretnina_controller_1.NekretninaController().dohvatiBrojStanovaKojiSeProdaju(req, res));
